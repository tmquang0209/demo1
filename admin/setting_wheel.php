...
if(isset($_POST["update20k"])){
    ...
    $tyle202s = tmq_boc($_POST["tyle202"]);
    $tyle203s = tmq_boc($_POST["tyle203"]);
    $tyle204s = tmq_boc($_POST["tyle204"]);
    $tyle205s = tmq_boc($_POST["tyle205"]);
    $tyle206s = tmq_boc($_POST["tyle206"]);
    $tyle207s = tmq_boc($_POST["tyle207"]);
    $tyle208s = tmq_boc($_POST["tyle208"]);
    $tyle209s = tmq_boc($_POST["tyle209"]);
    $tyle2010s = tmq_boc($_POST["tyle2010"]);
...
<span aria-hidden="true">&times;</span>
        ...
        `tyle2010` = '$tyle2010s'
        ");
        $TMQ_ketqua = '<div class="sufee-alert alert with-close alert-success alert-dismissible fade show">
<span class="badge badge-pill badge-success">Thành công</span>
Cập nhật thông tin vòng quay thành công.
<button type="button" class="close" data-dismiss="alert" aria-label="Close">
<span aria-hidden="true">&times;</span>
</button>
</div>';
...
<div class="col col-md-2"><label>20 Triệu Vàng</label><input type="text" name="tyle2010" class="form-control" value="<?=$tyle2010;?>"></div>
                       ...
                       <button type="submit" class="btn btn-primary" name="update20k">Cập nhật</button>
                        </form>
                            </div>
                            </div>
                        </div>
